...
{
    public partial class Education_Details : Form
    {
        ...
        private void Education_Details_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query_serch = "SELECT * FROM Education_Details WHERE Register_No = '" + Re + "'";
            SqlCommand cmnd = new SqlCommand(query_serch, con);
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("Select * from Education_Details", con);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string deletesql = "delete FROM Education_Details WHERE Register_No= '" + Re + "'";
